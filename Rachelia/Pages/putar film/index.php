  ...
  <body>
    ...
    <script>
      ...
      Authorization:
        ...
        videoPlayer.innerHTML = `<iframe allow="autoplay; encrypted-media" autoplay="true" style="width:100%; height:90vh;" src="https://www.youtube.com/embed/${data.youtube[1].source}?autoplay=1&si=b3EIjtPyCnHGWpn8&amp;controls=1;rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`
      })
