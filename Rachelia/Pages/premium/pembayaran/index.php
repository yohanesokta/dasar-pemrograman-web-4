...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../../css/premium/pembayaran/pembayaran.css">
  </head>
  <body>
      ...
      <div class="content">
        ...
        <div class="isicontent">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><b><label for="metode">Metode Pembayaran : </label></b></td>
                        <td><p id="metode" name="metode"> QRIS </p></td>
                    </tr>
                </table>
                <div class="pscan">
                    <p>Scan disini untuk pembayaran ! </p>
                    <img src="qrpalsu.png" alt="QR Code" width="200" height="200">
                </div>
