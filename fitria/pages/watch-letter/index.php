        ...
        <div class="content">
            <main id="main">
                <div class="film-container">
                    <h1 class="section-title"><i id='icn-letter' class="fa-solid fa-clock-rotate-left" ></i> Watch Letter Films</h1>

                    <div class="film-grid">
                        
                        <?php if($user_history){foreach($user_history as $history) { if ($history[6] == 1) {  ?>

                        <a href="../../../yohanes/detail?id=<?php echo $history[2] ?>" class="film-card">
                            <img src="https://image.tmdb.org/t/p/original<?php echo $history[4]?>"
                                alt="Batman v Superman: Dawn of Justice" class="film-poster">
                            <div class="film-info">
                                <h3 class="film-title"><?php echo $history[3]?></h3>
                                <div class="film-meta">
